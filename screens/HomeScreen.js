...
export default class HomeScreen extends React.Component {
  ...
  render() {
    TranslatorConfiguration.setConfig(ProviderTypes.Google, 'AIzaSyDlgCrKTNtRgmIGqRxEnEiYd64dTNN0z2M', this.state.languageCode);
        ...
        <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
          ...
          <View style={styles.titleContainer}>
            ...
            <Text style={styles.title_description}>
              Translator allows you to translate a word or sentence to several languages you desire
            </Text>
          </View>
          ...
          <View style={styles.welcomeContainer}>
            <Image
              source={
                __DEV__
                  ? require('../assets/images/translator1.png')
                  : require('../assets/images/translator2.png')
              }
